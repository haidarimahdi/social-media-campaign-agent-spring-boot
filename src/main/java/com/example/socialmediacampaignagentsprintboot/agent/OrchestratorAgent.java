...
public interface OrchestratorAgent {
    ...
    @SystemMessage("""
        ...
        Your ONLY job is to take a user's goal, evaluate it, and generate a plan.
            ...
            1. FIRST call 'validateGoal' with the user's goal.
            2. If INVALID, stop and return an error.
            3. If VALID, you MUST call the 'createCampaignPlan' tool.
            4. Wait for the tool to return a SUCCESS message.
            5. NEVER return 'PLAN_READY' unless you have successfully executed the 'createCampaignPlan' tool first.
        """)
